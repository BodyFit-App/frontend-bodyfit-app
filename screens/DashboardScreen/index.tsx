 ...
 *
 * This component represents the main dashboard screen for the user. It displays the user's profile
 * information, activity progress, recent goals, exercises, and programs. It also includes a pie chart
 * for visualizing the user's progress in different categories.
 *
 * @component
 * @example
 * return <DashboardScreen navigation={navigation} route={route} />;
 *
 * @param {StackScreenProps<AppParamListBase, "HomeScreen">} props - The navigation and route props provided by the Stack Navigator.
